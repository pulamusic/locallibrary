...
from django.contrib.auth.models import User, Permission # Required to assign User as a borrower and to grant the permission needed to set a book as returned.
